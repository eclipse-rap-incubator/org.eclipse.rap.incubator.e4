...
final class ManifestModifier extends ResourceModifier {
  ...
  public ManifestModifier( AbstractRAPWizard wizard ) {
    ...
    importPackage = wizard.getImportPackagesAsString();
    ...
    try {
      ...
      try {
        ...
        try {
          ...
          if( shouldModifyActivator && ( activatorName != null || importPackage != null ) ) {
        	  if( importPackage != null ) {
        		  writer.write( "Import-Package: " + importPackage + NL ); //$NON-NLS-1$
        	  } else {
